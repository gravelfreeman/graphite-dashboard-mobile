...
Chip card template for the homepage
```
...
Helper Template to show total number of lights ON
...
Chip card template for individual room
...
Helper Template to show total number of lights ON per room
```
{%- set search_state = 'on' %}
